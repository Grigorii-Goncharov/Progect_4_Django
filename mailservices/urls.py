...
urlpatterns = [
    ...
    path(
        "users/<int:user_id>/",
        views.UserRecipientListView.as_view(),
        name="user_recipient_list",
    ),
    path(
    ...
    path(
        "users/<int:user_id>/mailing/",
        views.UserMailingListView.as_view(),
        name="user_mailing_list",
    ),
    path(
        "users/toggle-mailing/<int:pk>/",
        views.toggle_user_block_mailing,
        name="toggle_user_block_mailing",
    ),
]
